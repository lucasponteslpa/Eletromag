...
while teta[len(teta)-1] <= np.pi/2:
    #coloca no vetor o pontencial correspondente ao ponto P
    res.append(potencial_total(N,P,ro,a))
    #coloca no vetor o angulo da proxima iteracao para calcular o pontencial
    teta.append(teta[len(teta)-1]+np.pi/20)
    #atualiza o proximo ponto a ser calculado o potencial
